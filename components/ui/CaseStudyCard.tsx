    ...
    <Card className={`h-[400px] w-full ${className}`} variant="elevated">
      ...
      >
        <div className="absolute inset-0 bg-black/60 rounded-xl flex flex-col justify-end pt-6 pb-3 px-6 items-center text-center">
          ...
          <span
            className="font-sans text-base font-semibold text-black bg-primary-accent rounded-full px-4 py-2 mb-2 inline-block shadow-lg border-2 border-primary-accent/80 max-w-md break-words whitespace-pre-line"
          >
            {result}
          </span>
        </div>
