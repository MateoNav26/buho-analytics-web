    ...
    <section id="servicios" className="py-20 md:py-28 px-4 bg-black relative overflow-hidden">
        ...
        >
          <defs>
            <pattern
              ...
              patternTransform="translate(7.8,0)"
            >
              <path
                d="M 0 0 L 0 12"
                fill="none"
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-white-raw mb-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Card 1 */}
          <div className="bg-neutral-900/40 shadow-lg shadow-black/30 border border-neutral-800 rounded-[2.25rem] p-6 text-white-raw flex flex-col h-full backdrop-blur-sm">
          ...
          <div className="bg-neutral-900/40 shadow-lg shadow-black/30 border border-neutral-800 rounded-[2.25rem] p-6 text-white-raw flex flex-col h-full backdrop-blur-sm">
            ...
            <p className="font-serif italic text-primary-accent mb-3">Demostrar que lo que hacés, realmente transforma.</p>
