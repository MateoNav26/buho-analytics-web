...
const vistaSteps = [
  {
    letter: "V",
    title: "Ver",
    description: "Observamos y analizamos los datos desde múltiples perspectivas, identificando patrones ocultos y tendencias emergentes que otros métodos podrían pasar por alto.",
  },
  {
    letter: "I",
    title: "Interpretar",
    description: "Aplicamos contexto sociológico y cultural para dar significado a los datos, transformando números en narrativas humanas comprensibles y accionables.",
  },
  {
    letter: "S",
    title: "Sintetizar",
    description: "Integramos insights cualitativos y cuantitativos en una visión coherente, conectando puntos aparentemente dispares para revelar la imagen completa.",
  },
  {
    letter: "T",
    title: "Transformar",
    description: "Convertimos los hallazgos en estrategias concretas y soluciones innovadoras que generan valor real e impacto medible para nuestros clientes.",
  },
  {
    letter: "A",
    title: "Activar",
    description: "Implementamos las soluciones con precisión algorítmica, monitoreando resultados y optimizando continuamente para maximizar el retorno de inversión.",
  }
];
          ...
          <svg className="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
            <defs>
              <pattern id="grid" width="10" height="10" patternUnits="userSpaceOnUse">
                <path d="M 10 0 L 0 0 0 10" fill="none" stroke="currentColor" strokeWidth="0.5" className="text-primary-accent"/>
              </pattern>
            </defs>
...
export default function Methodology() {
  ...
  const stepRefs = useRef<(HTMLDivElement | null)[]>(vistaSteps.map(() => null));
  ...
  return (
    <section ref={containerRef} className={`${styles.methodologySection} py-20 md:py-32 bg-black relative`}>
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          >
            Un enfoque único que combina la precisión algorítmica con la interpretación sociológica
          </motion.p>
          <motion.div 
        ...
        {/* Two-Column Grid */}
        <div className={`${styles.methodologyGrid} grid lg:grid-cols-2 gap-12 lg:gap-20 max-w-7xl mx-auto`}>
          {/* Left Column - Sticky Visual */}
          <div className={styles.stickyVisualContainer}>
        ...
        >
          <p className="font-sans text-lg text-white-raw/70 mb-6">
            ¿Listo para transformar sus datos con nuestra metodología V.I.S.T.A.?
          </p>
          <motion.button
